    ...
    function cuadro_texto($configuracion, $atributos) {
        ...
        if (!isset($atributos["tipo"]) || $atributos["tipo"] != 'hidden') {
            ...
            if (isset($atributos ["estiloEnLinea"]) && $atributos ["estiloEnLinea"] != "") {
                $this->mi_cuadro.= "style='" . $atributos ["estiloEnLinea"] . "' ";
            }
            ...
            if (isset($atributos["name"]) && $atributos["name"] != "") {
                ...
                if (isset($atributos['seguridad'])) {
                    $this->mi_cuadro.="name='" . sha1($atributos["id"] . $atributos['seguridad']) . "' ";
                } else {
            ...
            if (isset($atributos['seguridad'])) {
                $this->mi_cuadro.="id='" . sha1($atributos["id"] . $atributos['seguridad']) . "' ";
            } else {
