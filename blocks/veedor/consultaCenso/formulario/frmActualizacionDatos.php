...
$atributos["estilo"] = "jqueryui";
$atributos["columnas"] = "2"; //El control ocupa 32% del tamaño del formulario
$atributos["validar"] = "required, minSize[4], maxSize[10], custom[integer], number";
$atributos["categoria"] = "";
echo $this->miFormulario->campoCuadroTexto($atributos);
unset($atributos);
...
$atributos["estilo"] = "jqueryui";
$atributos["columnas"] = "2"; //El control ocupa 32% del tamaño del formulario
$atributos["validar"] = "min[7], custom[integer], number, minSize[7], maxSize[7]";
$atributos["valor"] = "";
$atributos["categoria"] = "";
echo $this->miFormulario->campoCuadroTexto($atributos);
unset($atributos);
...
$atributos["estilo"] = "jqueryui";
$atributos["columnas"] = "2"; //El control ocupa 32% del tamaño del formulario
$atributos["validar"] = "min[10], custom[integer], number, minSize[10], maxSize[10]";
$atributos["categoria"] = "";
echo $this->miFormulario->campoCuadroTexto($atributos);
unset($atributos);
...
//-------------Control cuadroTexto-------------------------------------
    ...
    $atributos["estilo"] = "jqueryui";
    $atributos["columnas"] = "1"; //El control ocupa 32% del tamaño del formulario
    $atributos["validar"] = "required, custom[integer], number";
    $atributos["categoria"] = "";
    $atributos["deshabilitado"] = true;
...
//-------------Control cuadroTexto-------------------------------------
    ...
    $atributos["estilo"] = "jqueryui";
    $atributos["columnas"] = "2"; //El control ocupa 32% del tamaño del formulario
    $atributos["validar"] = "minSize[4], maxSize[4], custom[integer], number";
    $atributos["categoria"] = "";
    echo $this->miFormulario->campoCuadroTexto($atributos);
    unset($atributos);
...
//-------------Control cuadroTexto-------------------------------------
    ...
    $atributos["estilo"] = "jqueryui";
    $atributos["columnas"] = "2"; //El control ocupa 32% del tamaño del formulario
    $atributos["validar"] = "min[1],max[3], custom[integer], number, maxSize[1]";
    $atributos["categoria"] = "";
    echo $this->miFormulario->campoCuadroTexto($atributos);
    unset($atributos);
