...
unset($atributos);
?>
<input type="hidden" name="totalVotos" id="totalVotos" />
<?php

$atributos["id"]="chart1";
$atributos["estilo"]="height:300px; width:500px;";
echo $this->miFormulario->division("inicio",$atributos);
unset($atributos);
...
<div class="demo-containerGrafico">
	<div id="placeholder" class="demo-placeholderGrafico"></div>
</div>
