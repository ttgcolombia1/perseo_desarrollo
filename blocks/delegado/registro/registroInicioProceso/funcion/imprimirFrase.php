...
//$contenidoPagina .= "<page>";
    $contenidoPagina .= "<p>La frase de seguridad para el proceso electoral se creó con éxito, por seguridad usted puede imprimir este documento en caso de que la olvide. Este documento queda bajo la responsabilidad de la persona delegada para esta función</p>";
    $contenidoPagina .= "<p>La frase de seguridad es: <b>".$_REQUEST['frase']."</b></p>";
$contenidoPagina .= "</page>";


    $html2pdf = new HTML2PDF('P','LETTER','es');
    $res = $html2pdf->WriteHTML($contenidoPagina);
    $html2pdf->Output('fraseSeguridad.pdf','D');
?>