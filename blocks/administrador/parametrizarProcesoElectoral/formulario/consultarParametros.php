...
//        $atributos["texto"]="Fecha Fin: ".$resultadoProceso[0]['fechafin'];
        ...
        $atributos ['enlaceTexto'] = "Fecha Fin: ".$resultadoProceso[0]['fechafin'];
        
        //echo $this->miFormulario->campoTexto($atributos);
        
      	// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
        $variable = "pagina=parametrizarProcesoElectoral"; //pendiente la pagina para modificar parametro                                                        
        $variable.= "&opcion=ajustarFechaProceso";
        $variable.= "&usuario=" . $miSesion->getSesionUsuarioId();
        $variable.= "&proceso=" .$resultadoProceso[0]['idprocesoelectoral'];
        ...
        $atributos ['enlace'] = $variable;
        $atributos ['tabIndex'] = 1;
        $atributos ['enlaceTexto'] = "Fecha Inicio: ".$resultadoProceso[0]['fechainicio'];
        ...
        {   unset($atributos);
            ...
            include($this->ruta."formulario/tabs/tabEditaEleccion.php"); 
